          ...
          {f.isImage && f.dataUrl ? (
            <div className="relative w-16 h-16 rounded-lg overflow-hidden bg-neutral-700">
              ...
              <button
                ...
                className="absolute -top-1 -right-1 w-5 h-5 flex items-center justify-center rounded-full bg-neutral-900/80 text-neutral-400 hover:text-red-400"
              >
            ...
            <div className="flex items-center gap-1.5 pl-2.5 pr-1 py-1 rounded-lg bg-neutral-700 text-xs text-neutral-300 max-w-[180px]">
